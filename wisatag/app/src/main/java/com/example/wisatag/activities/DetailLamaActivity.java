...
public class DetailLamaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_lama);
        ...
        modelLama = (ModelLama) getIntent().getSerializableExtra("detailWisata");
        if (modelLama != null) {
            idWisata = modelLama.getIdWisata();
            NamaWisata = modelLama.getTxtNamaWisata();
            ...
            //get Image
            Glide.with(this)
                    .load(modelLama.getGambarWisata())
                    ...
                    public void onResponse(JSONObject response) {
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                e.printStackTrace();
                                Toast.makeText(DetailLamaActivity.this,
