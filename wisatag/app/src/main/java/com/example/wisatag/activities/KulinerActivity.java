...
public class KulinerActivity extends AppCompatActivity implements WisataAdapter.onSelectData {
    ...
    private void getWisata() {
        progressDialog.show();
        AndroidNetworking.get(Api.WisataKuliner)
    ...
    private void showWisata() {
        wisataAdapter = new WisataAdapter(KulinerActivity.this, modelWisata, this);
        rvWisata.setAdapter(wisataAdapter);
    }

    @Override
    public void onSelected(ModelWisata modelWisata) {
        Intent intent = new Intent(KulinerActivity.this, DetailWisataActivity.class);
