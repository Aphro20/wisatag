...
public class AlamActivity extends AppCompatActivity implements WisataAdapter.onSelectData {
    ...
    private void getWisataAlam() {
        ...
        PhotoCall.enqueue(new Callback<List<ModelWisata>>() {
            ...
            public void onFailure(Call<List<ModelWisata>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(AlamActivity.this,"Gagal menampilkan data!", Toast.LENGTH_SHORT).show();
    ...
    private void showWisata() {
        wisataAdapter = new WisataAdapter(AlamActivity.this, WisataList, this);
